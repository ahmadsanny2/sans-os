...
export function DialoguePracticeView({
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      {/* Workspace Split Layout: Form and Conversations */}
      <div className="grid gap-6 lg:grid-cols-5 items-start">
        
        {/* Left Card: Add Dialogue Form (Column Span 2) */}
              ...
              <div className="space-y-3 border-l-2 border-violet-500 pl-3.5 py-0.5">
                ...
                <div className="space-y-2">
                  <input
                    ...
                    className="w-full rounded-lg border border-border bg-background px-3 py-1.5 text-xs outline-none transition-all focus:border-sidebar-primary focus:ring-1 focus:ring-sidebar-primary/10"
                  />
                  <input
                    type="text"
                    required
        ...
        {/* Right Section: Dialogue Practice Logs History (Column Span 3) */}
        <div className="lg:col-span-3 space-y-4">
          
          {/* Top Bar actions (Search + Show/Hide translations) */}
          <div className="flex flex-col sm:flex-row gap-3 items-center justify-between border-b border-border/40 pb-3">
            ...
            <div className="flex gap-1.5 p-0.5 bg-secondary/20 border border-border/30 rounded-xl select-none shrink-0 self-start sm:self-auto">
              <button
                ...
                className="px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider text-muted-foreground hover:text-foreground transition-all flex items-center gap-1.5"
              >
          ...
          {/* Conversations listing container */}
          {isLoading ? (
              ...
              {searchQueryDialogue ? (
                ...
                <>
                  ...
                  <p className="text-xs text-muted-foreground/80 mt-1 max-w-xs mx-auto">
                    Select a vocabulary word on the left and write a Q&A conversation practice to get started.
                  </p>
                </>
              )}
            </div>
